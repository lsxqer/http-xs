...
export declare type Method = "post" | "get" | "put" | "delete" | "head" | "options" | "patch";
export declare type PromiseFunction<T> = (...args: any) => Promise<T>;
...
export interface RequestInterface {
     ...
     */
    responseType?: "utf8" | "buffer" | "u8array" | "stream" | "formData" | "arrayBuffer" | "json" | "blob" | "text" | "";
    /**
...
export interface IXsEventTarget {
    ...
    removeEventListener(type: string, listener: (event: any) => void): any;
}
