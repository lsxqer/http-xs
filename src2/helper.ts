import { HeaderOption, RequestInterface, RequestPayload } from "./typedef";
...
export function maergeConfig(url:string|Partial<RequestPayload|RequestInterface|HeaderOption>,config?:Partial<RequestPayload|RequestInterface|HeaderOption>) : RequestPayload & RequestInterface & HeaderOption {
